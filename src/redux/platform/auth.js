...
const checkUpdateMaxFriendsSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/checkUpdateMaxFriends", {
      body: {
        user_id
      }
    });
...
const checkUserSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/check_user", {
...
const setPasswordSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/setPassword", {
      body: {
        email: email,
        password: password,
      }
...
const trialPackageSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/trialPackage", {
      body: {
        email: email,
      }
    });
...
const importMembersSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/import_members", {
      body: {
        members,
        start_date,
        expire_date,
...
const registerSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/register", {
      body: {
        email: email,
        password: password,
...
const updateProfileSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/updateProfile", {
      body: {
        email: email,
        other_attributes,
        displayName
...
const signupUserSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/signup", {
      body: {
        email: email,
        password: password,
        first_name: firstname,
...
const getExpireDateSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getExpireDate", {
      queryStringParameters: {
        email
      }
    });
...
const changeEmailSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/changeEmail", {
      body: {
        email,
        new_email
      }
...
const getGroupIDSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getGroupID", {
      queryStringParameters: {
        user_id
      }
    });
...
const resetPasswordSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/resetPassword", {
      body: {
        email,
        user_id,
        expire_time
...
const forgotPasswordSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/forgotPassword", {
      queryStringParameters: {
        email
      }
    });
...
const loginUserSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/login", {
      queryStringParameters: {
        email: email,
        password: password
      }
