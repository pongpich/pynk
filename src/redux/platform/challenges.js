...
const cancelFriendRequestSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/cancelFriendRequest", {
      body: {
        sender_id,
        receiver_id
      }
...
const cancelTeamInviteSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/cancelTeamInvite", {
      body: {
        sender_id,
        receiver_id
      }
...
const getFriendRequestSentSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getFriendRequestSent", {
...
const getTeamInviteSentSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getTeamInviteSent", {
      queryStringParameters: {
        user_id
      }
    });
...
const checkAllMissionCompleteSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/checkAllMissionCompelete", {
      body: {
        user_id
      }
    });
...
const updateAchievementLogSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/updateAchievementLog", {
      body: {
        user_id,
        achievement_name
      }
...
const getAchievementLogSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getAchievementLog", {
      queryStringParameters: {
        user_id
      }
    });
...
const acceptTeamInviteSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/acceptTeamInvite", {
      body: {
        user_id,
        group_id,
        log_id
...
const rejectTeamInviteSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/rejectTeamInvite", {
      body: {
        log_id
      }
    });
...
const getTeamInviteSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getTeamInvite", {
      queryStringParameters: {
        user_id
      }
    });
...
const sendTeamInviteSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/sendTeamInvite", {
      body: {
        user_id,
        to
      }
...
const getFriendsRankSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getFriendsRank", {
      queryStringParameters: {
        user_id
      }
    });
...
const deleteFriendSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/deleteFriend", {
      body: {
        user_id,
        friend_email
      }
...
const rejectFriendSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/rejectFriend", {
      body: {
        log_id
      }
    });
...
const acceptFriendSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/acceptFriend", {
      body: {
        user_id,
        sender_id,
        log_id
...
const getFriendRequestSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getFriendRequest", {
      queryStringParameters: {
        user_id
      }
    });
...
const sendFriendRequestSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/sendFriendRequest", {
      body: {
        user_id,
        to
      }
...
const getMaxFriendsSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getMaxFriends", {
      queryStringParameters: {
        user_id
      }
    });
...
const getFriendListSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getFriendList", {
      queryStringParameters: {
        user_id
      }
    });
...
const getRankSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getRank", {
      queryStringParameters: {
        user_id,
        start_date
      }
...
const getLogWeightSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getLogWeight", {
      queryStringParameters: {
        user_id
      }
    });
...
const getNumberOfTeamNotFullSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getNumberOfTeamNotFull", {
      queryStringParameters: {
        fb_group
      }
    });
...
const getLeaderboardSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getLeaderboard", {
      queryStringParameters: {
      }
    });
    return apiResult
...
const getChallengePeriodSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getChallengePeriod", {
      queryStringParameters: {
      }
    });
    return apiResult
...
const getLogWeightTeamSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getLogWeightTeam", {
      queryStringParameters: {
        group_id
      }
    });
...
const getIsReducedWeightSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getIsReducedWeight", {
      queryStringParameters: {
        user_id
      }
    });
...
const selectMemberEventLogSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/selectMemberEventLog", {
      queryStringParameters: {
        email
      }
    });
...
const getDailyWeighChallengeSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getDailyWeighChallenge", {
      queryStringParameters: {
        user_id
      }
    });
...
const postDailyWeighChallengeSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/daily_weight_score", {
      body: {
        user_id,
        weight
      }
...
const assignGroupToMemberSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/assignGroupToMember", {
      body: {
        user_id,
        start_date,
        fb_group
...
const createChallengeGroupSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/createChallengeGroup", {
      body: {
        user_id,
        group_name,
        start_date,
...
const leaveTeamSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/leaveTeam", {
      body: {
        user_id
      }
    });
...
const getMembersAndRankSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getMembersAndRank", {
      queryStringParameters: {
        group_id,
        start_date
      }
...
const getGroupNameSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getGroupName", {
      queryStringParameters: {
        group_id
      }
    });
...
const getScoreOfTeamSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getScoreOfTeam", {
      queryStringParameters: {
        group_id
      }
    });
...
const getDailyTeamWeightBonusSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getDailyTeamWeightBonus", {
      queryStringParameters: {
        user_id
      }
    });
