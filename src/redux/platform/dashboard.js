...
const getGamificationSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getGamification", {
...
const getMemberInSeasonSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getMemberInSeason", {
      queryStringParameters: {
        season
      }
    });
...
const getBestClipInSeasonSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getBestClipInSeason", {
      queryStringParameters: {
      }
    });
    return apiResult;
...
const getWorstClipInSeasonSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getWorstClipInSeason", {
      queryStringParameters: {
      }
    });
    return apiResult;
...
const getDateOfJoiningChallengeSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getDateOfJoiningChallenge", {
      queryStringParameters: {
        user_id
      }
    });
...
const getChallengeEventSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getChallengeEvent", {
      queryStringParameters: {
      }
    });
    return apiResult;
...
const getMembersEachWeekInSeasonSagaAsync = async (
    ...
    try {
      const apiResult = await API.get("bebe_platform", "/getMembersEachWeekInSeason", {
        queryStringParameters: {
        }
      });
     return apiResult;
