...
const getAllMemberStayFitSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getAllMemberPlatfrom", {
...
const getCheckDisplayNameSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/checkDisplayName", {
      queryStringParameters: {
        display_name
      }
    });
...
const getMemberInfoSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/getMemberInfo", {
      queryStringParameters: {
        user_id
      }
    });
...
const check4WeeksPromptSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/check4WeeksPrompt", {
      queryStringParameters: {
        user_id
      }
    });
...
const checkRenewPromptSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/checkRenewPrompt", {
      queryStringParameters: {
        user_id
      }
    });
...
const checkQuestionnaireLogSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/checkQuestionnaireLog", {
      queryStringParameters: {
        user_id,
        log
      }
...
const checkNewsLogSagaAsync = async (
  ...
  try {
    const apiResult = await API.get("bebe_platform", "/checkNewsLog", {
      queryStringParameters: {
        user_id,
        log
      }
