...
const updateFittoPlantSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/updateFittoPlant", {
      body: {
        user_id,
        data
      }
...
const updateAddressSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/updateAddress", {
      body: {
        user_id,
        data
      }
...
const updateDisplayNameSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/updateDisplayName", {
      body: {
        user_id,
        display_name
      }
...
const checkProgramLevelSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/checkProgramLevel", {
      body: {
        user_id
      }
    });
...
const insertQuestionnaireLogSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/insertQuestionnaireLog", {
      body: {
        user_id,
        log
      }
...
const insertNewsLogSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/insertNewsLog", {
      body: {
        user_id,
        log
      }
...
const updateStatusLowImpactSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/updateStatusLowImpact", {
      body: {
        user_id,
        status_low_impact
      }
...
const updateProgramLevelSagaAsync = async (
  ...
  try {
    const apiResult = await API.put("bebe_platform", "/updateProgramLevel", {
      body: {
        user_id,
        program_level
      }
...
const updateProgramPromptLogSagaAsync = async (
  ...
  try {
    const apiResult = await API.post("bebe_platform", "/updateProgramPromptLog", {
      body: {
        user_id,
        log_name,
        log_value
